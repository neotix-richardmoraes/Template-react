...
var CircularProgress = /*#__PURE__*/external_react_.forwardRef(function CircularProgress(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement("div", _extends({
    className: external_clsx_default()(classes.root, className, color !== 'inherit' && classes["color".concat(capitalize(color))], {
    ...
    ref: ref,
    role: "progressbar"
  }, rootProps, other), /*#__PURE__*/external_react_.createElement("svg", {
    className: classes.svg,
    viewBox: "".concat(SIZE / 2, " ").concat(SIZE / 2, " ").concat(SIZE, " ").concat(SIZE)
  }, /*#__PURE__*/external_react_.createElement("circle", {
    className: external_clsx_default()(classes.circle, disableShrink && classes.circleDisableShrink, {
 ...
 false ? 0 : void 0;
/* harmony default export */ var CircularProgress_CircularProgress = (styles_withStyles(styles, {
